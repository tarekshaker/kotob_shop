 ...
 */
final class Version20190114000807 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE `order` ADD userId VARCHAR(255) NOT NULL, DROP user_id_id');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE `order` ADD user_id_id INT DEFAULT NULL, DROP userId');

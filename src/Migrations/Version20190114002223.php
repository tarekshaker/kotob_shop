 ...
 */
final class Version20190114002223 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE `order` ADD user_id_id INT DEFAULT NULL, DROP user_id');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE `order` ADD user_id INT NOT NULL, DROP user_id_id');
    }
}
